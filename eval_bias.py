...
## how to run the file?
## python eval_bias.py --model_path=./best_models/word2vec_nll.model --weat_file_path=./data/weat.json --out_file=./submission/nll_bias_output.json
## python eval_bias.py --model_path=./best_models/word2vec_neg.model --weat_file_path=./data/weat.json --out_file=./submission/neg_bias_output.json
